...
module TwoB
  class ThreadView
    ...
    def write_body(_erbout)
      ...
      ; _erbout.concat "\t<link rel=\"stylesheet\" type=\"text/css\" href=\"/thread.css\" />\n"
      ; _erbout.concat "\t<script type=\"text/javascript\" src=\"/jquery-1.3.1.js\"></script>\n"
      ; _erbout.concat "\t<script type=\"text/javascript\" src=\"/popup.js\"></script>\n"
      ; _erbout.concat "</head>\n"
      ; _erbout.concat "\n"
      ...
      ; _erbout.concat "\t\t\t<li><a href=\"./\">\345\205\250\343\203\254\343\202\271\350\241\250\347\244\272</a></li>\n"
      ; _erbout.concat "\t\t\t<li><a href=\"./subscribe5\">\347\266\232\343\201\215\343\202\222\350\263\274\350\252\255</a></li>\n"
      ; _erbout.concat "\t\t\t<li><a href=\"#firstNew\">\346\226\260\347\235\200\343\201\253\343\202\270\343\203\243\343\203\263\343\203\227</a></li>\n"
      ; _erbout.concat "\t\t\t<li><a href=\"./delete_cache?reload=subscribe5#firstNew\">\343\202\255\343\203\243\343\203\203\343\202\267\343\203\245\343\202\222\343\202\257\343\203\252\343\202\242</a></li>\n"
      ...
      ; _erbout.concat "\t\t\t\t\t<span class=\"name\">"; _erbout.concat((h res.name ).to_s);  if res.has_trip? then ; _erbout.concat " <span class=\"trip\">\342\227\206"; _erbout.concat((h res.trip ).to_s); _erbout.concat "</span>";  end ; _erbout.concat "</span>\n"
